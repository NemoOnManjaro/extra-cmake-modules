...
groups=(kf6)
source=(https://download.kde.org/unstable/frameworks/${pkgver/.1/.0}/$pkgname-$pkgver.tar.xz{,.sig})
sha256sums=('917b4a9d0c431984acdca94422dc8ffc0d56bd9ebee591da82633fc38d9fea54'
            'SKIP')
